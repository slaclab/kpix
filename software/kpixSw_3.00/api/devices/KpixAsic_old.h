...
//-----------------------------------------------------------------------------
// Description :
// Header file for class for managing the KPIX ASIC.
//-----------------------------------------------------------------------------
...
/** \defgroup devices
 * Classes used to access kpix devices
 */

/** \ingroup devices */
//! Class to Kpix ASIC.
/*!
   This class is used to interface to a KPIX Asic device in a DAQ system.
*/
class KpixAsic {
      ...
      // Clock period used for acquistion timing
