...
Required Packages:
   ...
   Root Installation:
      ...
      Adjust the qt installation directory as neccessary. I had to disable
      ...
      There is no need to install as root will run in the directory it
      is compiled in.
...
Kpix Software Installation:
   ...
   package was un-tarred and compiled. (/u1/local/root).
