...
-- \   \   \/     Version: M.53d
--  \   \         Application: netgen
--  /   /         Filename: v5_icon.vhd
-- /___/   /\     Timestamp: Tue Nov 23 15:24:29 2010
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -w -sim -ofmt vhdl /afs/slac.stanford.edu/u/re/ausoori/projects/w_si/devel/firmware/KpixCon/xil_cores/tmp/_cg/v5_icon.ngc /afs/slac.stanford.edu/u/re/ausoori/projects/w_si/devel/firmware/KpixCon/xil_cores/tmp/_cg/v5_icon.vhd 
-- Device	: xc5vlx50t-ff1136-1
-- Input file	: /afs/slac.stanford.edu/u/re/ausoori/projects/w_si/devel/firmware/KpixCon/xil_cores/tmp/_cg/v5_icon.ngc
-- Output file	: /afs/slac.stanford.edu/u/re/ausoori/projects/w_si/devel/firmware/KpixCon/xil_cores/tmp/_cg/v5_icon.vhd
-- # of Entities	: 1
-- Design Name	: v5_icon
...
architecture STRUCTURE of v5_icon is
  ...
  signal NLW_U0_U_ICON_I_YES_BSCAN_U_BS_I_V5_ISYN_I_USE_SOFTBSCAN_EQ0_U_BS_CAPTURE_UNCONNECTED : STD_LOGIC; 
  signal NLW_U0_U_ICON_I_YES_BSCAN_U_BS_I_V5_ISYN_I_USE_SOFTBSCAN_EQ0_U_BS_RESET_UNCONNECTED : STD_LOGIC; 
...
begin
  ...
  U0_U_ICON_I_YES_BSCAN_U_BS_I_V5_ISYN_I_USE_SOFTBSCAN_EQ0_U_BS : BSCAN_VIRTEX5
    generic map(
      JTAG_CHAIN => 1
    )
    port map (
      TDO => U0_U_ICON_iTDO,
      CAPTURE => NLW_U0_U_ICON_I_YES_BSCAN_U_BS_I_V5_ISYN_I_USE_SOFTBSCAN_EQ0_U_BS_CAPTURE_UNCONNECTED,
      DRCK => U0_U_ICON_I_YES_BSCAN_U_BS_iDRCK_LOCAL,
      RESET => NLW_U0_U_ICON_I_YES_BSCAN_U_BS_I_V5_ISYN_I_USE_SOFTBSCAN_EQ0_U_BS_RESET_UNCONNECTED,
      SEL => U0_U_ICON_iSEL,
      SHIFT => U0_iSHIFT_OUT,
      TDI => U0_U_ICON_iTDI,
  ...
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O5_SW0 : LUT5
    generic map(
      INIT => X"A2A7F2F7"
    )
    port map (
  ...
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O5_SW1 : LUT4
    generic map(
      INIT => X"3120"
    )
    port map (
  ...
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O5_SW2 : LUT2
    generic map(
      INIT => X"8"
    )
    port map (
  ...
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O5 : LUT6
    generic map(
      INIT => X"A8B9203120312031"
    )
    port map (
      I0 => U0_U_ICON_iCORE_ID(0),
