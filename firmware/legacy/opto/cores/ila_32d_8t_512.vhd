...
-- \   \   \/     Version: K.39
--  \   \         Application: netgen
--  /   /         Filename: ila_32d_8t_512.vhd
-- /___/   /\     Timestamp: Wed Jun 17 13:54:54 2009
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -w -sim -ofmt vhdl /afs/slac.stanford.edu/u/ey/rherbst/projects/w_si/fpgas/opto_test/cores/tmp/_cg/ila_32d_8t_512.ngc /afs/slac.stanford.edu/u/ey/rherbst/projects/w_si/fpgas/opto_test/cores/tmp/_cg/ila_32d_8t_512.vhd 
-- Device	: xc3s400-pq208-5
-- Input file	: /afs/slac.stanford.edu/u/ey/rherbst/projects/w_si/fpgas/opto_test/cores/tmp/_cg/ila_32d_8t_512.ngc
-- Output file	: /afs/slac.stanford.edu/u/ey/rherbst/projects/w_si/fpgas/opto_test/cores/tmp/_cg/ila_32d_8t_512.vhd
-- # of Entities	: 1
-- Design Name	: ila_32d_8t_512
...
architecture STRUCTURE of ila_32d_8t_512 is
  signal N0 : STD_LOGIC; 
  signal N1 : STD_LOGIC; 
  signal U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_I_RDADDR_highAddr_ce : STD_LOGIC; 
  signal U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_I_RDADDR_lowAddr_inv : STD_LOGIC; 
  signal U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_I_RDADDR_lowAddr_rst : STD_LOGIC; 
  signal U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_muxAddrFF : STD_LOGIC; 
  ...
  signal U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_localDOA : STD_LOGIC_VECTOR ( 1 downto 0 ); 
  signal U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR : STD_LOGIC_VECTOR ( 14 downto 0 ); 
...
NLW_U0_I_YES_D_U_ILA_U_G2_SQ_U_CAPCTRL_U_CAP_ADDRGEN_U_WCNT_LCMP_I_SRL16_U_GAND_SRL16_I_TWMOD8_NE0_I_YES_RPM_I_SRLT_EQ_2_U_SRLH_Q_UNCONNECTED,
  ...
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_I_MUX_U_RD_DATA_NO_LUT6_I1_U_LUT3 : LUT3
    generic map(
      INIT => X"CA"
    )
    port map (
      I0 => U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_localDOA(0),
      I1 => U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_localDOA(1),
      I2 => U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_muxAddrFF,
      O => U0_I_YES_D_U_ILA_iDATA_DOUT
    );
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_I_RDADDR_I_NI_GT_1_I1_U_LUT : LUT2
    generic map(
      INIT => X"E"
    )
    port map (
  ...
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_I_RDADDR_I_NI_GT_1_IEQ1_U_lowAddr_inv : INV
    port map (
      I => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(0),
      O => U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_I_RDADDR_lowAddr_inv
    );
...
NLW_U0_I_YES_D_U_ILA_U_TRIG_U_TC_I_STORAGE_QUAL_U_STORAGE_QUAL_I_SRLT_NE_1_I_NMU_1_TO_4_U_TCL_I_NMU_EQ1_U_iDOUT_I_NOLUT6_I_SRL_T2_U_SRLC16E_Q15_UNCONNECTED
  ...
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_I_MUX_G_FF_0_U_FF : FDE
    ...
    port map (
      ...
      Q => U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_muxAddrFF
    );
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_I_RDADDR_I_NI_GT_1_IEQ1_U_lowAddr_0 : FDRE
    generic map(
      INIT => '0'
    )
    port map (
      C => CONTROL(0),
      CE => CONTROL(6),
      D => U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_I_RDADDR_lowAddr_inv,
  ...
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_G_BRAM_0_U_BRAM_ram_rt1_s1_s32_if_ram_rt1_s1_s32_i : RAMB16_S1_S36
    ...
    port map (
      ...
      ADDRA(13) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(14),
      ADDRA(12) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(13),
      ADDRA(11) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(12),
      ADDRA(10) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(11),
      ADDRA(9) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(10),
      ADDRA(8) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(9),
      ADDRA(7) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(8),
      ADDRA(6) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(7),
      ADDRA(5) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(6),
      ADDRA(4) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(5),
      ADDRA(3) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(4),
      ADDRA(2) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(3),
      ADDRA(1) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(2),
      ADDRA(0) => U0_I_YES_D_U_ILA_U_CAPSTOR_RD_ADDR(1),
      ...
      DIB(18) => N0,
      DIB(17) => N0,
      DIB(16) => U0_I_YES_D_U_ILA_iDATA(31),
      DIB(15) => U0_I_YES_D_U_ILA_iDATA(29),
      DIB(14) => U0_I_YES_D_U_ILA_iDATA(27),
      DIB(13) => U0_I_YES_D_U_ILA_iDATA(25),
      DIB(12) => U0_I_YES_D_U_ILA_iDATA(23),
      DIB(11) => U0_I_YES_D_U_ILA_iDATA(21),
      DIB(10) => U0_I_YES_D_U_ILA_iDATA(19),
      DIB(9) => U0_I_YES_D_U_ILA_iDATA(17),
      DIB(8) => U0_I_YES_D_U_ILA_iDATA(15),
      DIB(7) => U0_I_YES_D_U_ILA_iDATA(13),
      DIB(6) => U0_I_YES_D_U_ILA_iDATA(11),
      DIB(5) => U0_I_YES_D_U_ILA_iDATA(9),
      DIB(4) => U0_I_YES_D_U_ILA_iDATA(7),
      DIB(3) => U0_I_YES_D_U_ILA_iDATA(5),
      DIB(2) => U0_I_YES_D_U_ILA_iDATA(3),
      DIB(1) => U0_I_YES_D_U_ILA_iDATA(1),
  ...
  U0_I_YES_D_U_ILA_U_CAPSTOR_I_CASE1_I_NO_TB_I_RT1_U_RAM_G_BRAM_1_U_BRAM_ram_rt1_s1_s32_if_ram_rt1_s1_s32_i : RAMB16_S1_S36
    ...
    port map (
      ...
      DIB(17) => N0,
      DIB(16) => N0,
      DIB(15) => U0_I_YES_D_U_ILA_iDATA(30),
      DIB(14) => U0_I_YES_D_U_ILA_iDATA(28),
      DIB(13) => U0_I_YES_D_U_ILA_iDATA(26),
      DIB(12) => U0_I_YES_D_U_ILA_iDATA(24),
      DIB(11) => U0_I_YES_D_U_ILA_iDATA(22),
      DIB(10) => U0_I_YES_D_U_ILA_iDATA(20),
      DIB(9) => U0_I_YES_D_U_ILA_iDATA(18),
      DIB(8) => U0_I_YES_D_U_ILA_iDATA(16),
      DIB(7) => U0_I_YES_D_U_ILA_iDATA(14),
      DIB(6) => U0_I_YES_D_U_ILA_iDATA(12),
      DIB(5) => U0_I_YES_D_U_ILA_iDATA(10),
      DIB(4) => U0_I_YES_D_U_ILA_iDATA(8),
      DIB(3) => U0_I_YES_D_U_ILA_iDATA(6),
      DIB(2) => U0_I_YES_D_U_ILA_iDATA(4),
